                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nameOrganization" type="text" class="form-control @error('nameOrganization') is-invalid @enderror" name="nameOrganization" value="{{ old('nameOrganization') }}" required autocomplete="nameOrganization" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birthdayDate" type="date" class="form-control @error('birthdayDate') is-invalid @enderror" name="birthdayDate" value="{{ old('birthdayDate') }}" required autocomplete="birthdayDate" autofocus>
